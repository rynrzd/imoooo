...
export default async function ScannerPage() {
  ...
  return (
    <div className="space-y-5">
      <header>
        <h1 className="text-2xl font-semibold text-foreground">Rechercher un passeport</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Saisissez un identifiant Nireo ou scannez un QR code. S’il s’agit
          d’un de vos passeports, vous arrivez sur son dossier privé ; sinon,
