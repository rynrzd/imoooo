...
export const metadata: Metadata = {
  ...
  description: "Comment ImmoPilot collecte, utilise et protège vos données.",
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="Cette politique décrit les données traitées par ImmoPilot et l'usage qui en est fait. Elle repose sur un principe simple : vos données de gestion locative vous appartiennent et ne servent qu'à faire fonctionner le service."
      sections={[
        {
        ...
        },
        {
          title: "Cookies",
          paragraphs: [
            "ImmoPilot utilise uniquement des cookies techniques nécessaires à l'authentification et au maintien de votre session. Aucun cookie publicitaire ou de pistage tiers n'est déposé.",
          ],
        },
      ]}
    />
