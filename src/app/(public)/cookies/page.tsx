...
export const metadata: Metadata = {
  ...
  description: "Les cookies utilisés par ImmoPilot et leur finalité.",
...
export default function CookiesPage() {
  return (
    <LegalPage
      ...
      intro="ImmoPilot utilise uniquement des cookies strictement nécessaires au fonctionnement du service. Aucun cookie publicitaire, statistique ou de pistage tiers n'est déposé — c'est pourquoi aucune bannière de consentement n'est requise à ce jour."
      sections={[
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Vous pouvez supprimer les cookies depuis les réglages de votre navigateur. La suppression des cookies d'authentification vous déconnectera d'ImmoPilot.",
          ],
        },
      ]}
    />
