    ...
    <div className="grid gap-4 sm:grid-cols-[1.6fr_1fr]">
      <div className="rounded-2xl border border-white/8 bg-white/[0.02] p-4">
        ...
        <ul className="mt-3 space-y-2">
          {rows.map((r) => (
            <li key={r.name} className="flex items-center gap-3 rounded-xl border border-white/6 bg-white/[0.02] px-3 py-2.5">
...
function PropertyScene() {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      {props.map((p) => (
        <div key={p.name} className="overflow-hidden rounded-2xl border border-white/8 bg-white/[0.02]">
        ...
        {cats.map((c, i) => (
          <span
            ...
            className={cn(
              ...
              i === 0 ? "border-transparent bg-primary text-primary-foreground" : "border-white/10 text-muted-foreground"
            )}
          >
            {c}
          </span>
...
function ExpensesScene() {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-[1fr_1fr]">
      ...
      <div className="flex flex-col justify-between gap-4 rounded-2xl border border-white/8 bg-white/[0.02] p-4">
        <div>
...
function TenantsScene() {
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-3">
      {tenants.map((t) => (
        <div key={t.name} className="rounded-2xl border border-white/8 bg-white/[0.02] p-4">
          <div className="flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-full bg-gradient-to-br from-primary/30 to-primary/5 text-sm font-semibold text-foreground ring-1 ring-white/10">
          ...
          <div className="mt-3 flex items-center justify-between rounded-lg border border-white/6 bg-white/[0.02] px-2.5 py-1.5 text-[11px]">
    ...
    <div className="grid gap-4 sm:grid-cols-[1.6fr_1fr]">
      <div className="rounded-2xl border border-white/8 bg-white/[0.02] p-4">
        <div className="flex items-center justify-between">
          ...
          <p className="text-xs text-emerald-300">+8,4 %</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-1">
        {[
          ...
          <div key={k.l} className="rounded-2xl border border-white/8 bg-white/[0.02] p-3">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                on
                  ? "nireo-glass border-white/15 text-foreground"
                  : "border-white/8 text-muted-foreground hover:border-white/12 hover:text-foreground"
              )}
            >
              <span className={cn("grid size-9 shrink-0 place-items-center rounded-xl border border-white/8 transition-colors", on ? "bg-primary/15 text-primary" : "bg-white/[0.03]")}>
      ...
      <div className="nireo-glass nireo-hairline overflow-hidden rounded-3xl">
        <div className="flex items-center gap-2 border-b border-white/8 px-4 py-3">
          ...
          <span className="ml-auto flex items-center gap-1.5 text-[10px] text-muted-foreground">
            <span className="size-1.5 rounded-full bg-emerald-400" /> démo
          </span>
        </div>
